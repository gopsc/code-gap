...
#define SIM800C_RST_ON		GPIO_ResetBits(GPIOC, GPIO_Pin_9)
#define SIM800C_RST_OFF		GPIO_SetBits(GPIOC, GPIO_Pin_9)

#define SIM800C_PWRK_ON		GPIO_ResetBits(GPIOC, GPIO_Pin_4)
#define SIM800C_PWRK_OFF	GPIO_SetBits(GPIOC, GPIO_Pin_4)
