                ...
                if (num_round < 1000) {
                    ...
                    for (int i=0; i<=31; i=i+1) {
                        ...
                        if ( that == 10 ) {
                            ...
                            buffer_save  = to_string(num_force);
                            buffer_save += "\n";
                            //cout << buffer_save.length() << endl;

                            file_append( buffer_path_sound, buffer_save );

                            //cout << num_force << endl;
                            //if (num_force == 0) {
                            //    num_force =  1;}
                            //stringstream stream;
                            //            stream << (char)num_force;
                            //file_append( buffer_path_sound, stream.str() );
...
//--------------------------------------------------------------------------
                    ...
                    if ( num_aloud > 10 ) {
                        cout << "SOUND ALOUD:" << num_aloud << endl;
                        is_save = true;}
                    else {
                        if ( is_save == true ) {
                            is_save = false;
