                        ...
                        *information = that4;
                        ...
                        if (that5 == "Here." or that5 == "Recive.") {
                            ...
                            if (*command == "Update.") {
                                ...
                                if ( (*step_update)*500 > atoi(that_file_length.c_str()) ) {
                                    if ( control_update(update) == "Done.") {
                                        cout << "Done" << endl;
                                        *step_update = 0;
                                        that += '\n';
                                ...
                                that_file_length = to_string(that_file.length());
                                    ...
                                    that += ',';
                                    if ( (*step_update+1)*100 > atoi(that_file_length.c_str()) ) {
                                    ...
                                    that += '.';
                                    that += '\n';
                                    that += that_file.substr((*step_update)*100, 100);
                                    (*step_update)++;}
                            else {
                                *command = "";
                                that += "Who is that now?";}}
                            ...
                            if (*command == "Update.") { 
                                ...
                                if ( (*step_update)*100 > atoi(that_file_length.c_str()) ) {
                                    that += to_string(atoi(that_file_length.c_str())
                                                     -(*step_update)*100);}
                                else {
                                    that += to_string(100);}
                                ...
                                that += '.';
                                that += '\n';
                                that += that_file.substr((*step_update-1)*100, 100);}
                            else {
                                *command = "";}}
