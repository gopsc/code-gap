...
void fft() {
   ...
   //       result_sound[(int)n]*cos(2*M_PI*(double)w/N * (n-round+round))
   //     = result_sound[(int)n]*cos(2*M_PI*(double)w/N*(n-round)) * cos(2*M_PI*(double)w/N*round)
   //     - result_sound[(int)n]*sin(2*M_PI*(double)w/N*(n-round)) * sin(2*M_PI*(double)w/N*round)
