...
void  update_mix(int site) {
    ...
    string   cmd_update_rm  = "rm -rf ";
             cmd_update_rm += path_the;
             cmd_update_rm += "/";
             cmd_update_rm += name_the;

    string   cmd_update_mv  = "mv ";
             cmd_update_mv += path_the;
             cmd_update_mv += "/gop/downloads/";
             cmd_update_mv += name_the;
             cmd_update_mv += " ";
             cmd_update_mv += path_the;
             cmd_update_mv += "/";
