...
struct gopi_connection {
    ...
    struct gopi_system  system    [4]   [2];
    struct gopi_cpu     cpu       [4]   [2];
    struct gopi_memory  memory    [4]   [2];
    struct gopi_disk    disk      [4]   [2];
    struct gopi_network network   [4]   [2];
    struct gopi_sound   sound     [4]   [2];
