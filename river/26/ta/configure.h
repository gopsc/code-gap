...
//-------------------------cmd---------------------------
string   cmd_save                     = "bash /opt/ta/box/Linux/save.sh";
string   cmd_load                     = "bash /opt/ta/box/Linux/load.sh";
string   cmd_install                  = "bash /opt/ta/box/Linux/install.sh";

string   cmd_test                     = "bash /opt/ta/box/Linux/net.sh";
string   cmd_test_alsa                = "bash /opt/ta/box/Linux/alsa.sh";

string   cmd_ssh_restart_sudo         = "sudo service ssh restart";
string   cmd_reboot                   = "reboot";
//------------------------update"------------------------
string   cmd_update_rm                = "rm -rf /opt/ta";
string   cmd_update_mv                = "mv /opt/gop/downloads/ta /opt/";
//-------------------------sound-------------------------
