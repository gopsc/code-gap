           ...
           *pointer_next = '\0';
            ...
            if      ( 0            == strcmp(pointer_recv, "") ) {
               ...
               *pointer_next = '\0';
                ...
                for (
                        char*        pointer_network   =        pointer_recv;
                        strcmp("\n", pointer_network) != 0                  ;
                    ...
                    strcpy(
                            gop_connection.network[that_site].ip[1][number_ip],
                            pointer_network
                          );
                   *strstr(
                            gop_connection.network[that_site].ip[1][number_ip],
                   ...
                   ='\0';
                    ...
                    strcpy(
                            gop_connection.network[that_site].ip[2][number_ip],
                            strstr(pointer_network, " : ") + 3
                          );
                   *strchr( gop_connection.network[that_site].ip[2][number_ip], '\n' )
                   ='\0';
