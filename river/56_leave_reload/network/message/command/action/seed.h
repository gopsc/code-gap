...
void action_seed       (
    ...
    action_seed_append( buffer_file, buffer_path, "/box/c/output/print.h"                    );
    ...
    action_seed_append( buffer_file, buffer_path, "/box/c/system/deamon.h"                   );

    action_seed_append( buffer_file, buffer_path, "/box/c/commandline/shell.h"               );

    action_seed_append( buffer_file, buffer_path, "/box/c/secret/secret.h"                   );
